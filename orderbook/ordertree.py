...
class OrderTree(object):
    ...
    def get_orders_at_price(self, price: Decimal=None):
        if(price == None): 
            price = self.prices[0]
        ...
        orderlist_orders: OrderList = self.price_map[price]
        last_order : Order = orderlist_orders.get_head_order()
        orders : list[Order] = [last_order]
        
        while(last_order.next_order != None):
            last_order = last_order.next_order
